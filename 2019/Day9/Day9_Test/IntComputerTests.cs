...
namespace Day9_test
{
    public class IntComputerTests
    {
        ...
        public void BasicTest()
        {
            ...
            Assert.AreEqual(0, computer.Run(true));
        }
        ...
        public void ModeTest2()
        {
            ...
            Assert.AreEqual(1002, computer.Run(true));
        }
        ...
        public void ModeTest4()
        {
            ...
            Assert.AreEqual(700, computer.Run(700, true));
        }
        ...
        public void Day5Part1Test()
        {
            ...
            Assert.AreEqual(12896948, computer.Run(1,true));
        }
        ...
        public void Day5Part2Test()
        {
            ...
            Assert.AreEqual(7704130, computer.Run(5,true));
        }
